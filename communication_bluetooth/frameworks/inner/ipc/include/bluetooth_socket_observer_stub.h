...
#ifndef OHOS_BLUETOOTH_STANDARD_SOCKET_OBSERVER_STUB_H
#define OHOS_BLUETOOTH_STANDARD_SOCKET_OBSERVER_STUB_H
...
#endif  // OHOS_BLUETOOTH_STANDARD_SOCKET_OBSERVER_STUB_H